        ...
        match dir {
            Direction::Up | Direction::Down => {
                ...
                for dj in 1..=10 {
                    ...
                    if nj < matrix[0].len() {
                        pval += matrix[i][nj];
                        if dj >= 4 && pval < *visited.get(&(Direction::Right, (i, nj))).unwrap_or(&i32::MAX) {
                            heap.push((Reverse(pval), Direction::Right, (i, nj)));
                            visited.insert((Direction::Right, (i, nj)), pval);
                        }
                    }
                    ...
                    let nj = j - dj;
                    nval += matrix[i][nj];
                    if dj >= 4 && nval < *visited.get(&(Direction::Left, (i, nj))).unwrap_or(&i32::MAX) {
                        heap.push((Reverse(nval), Direction::Left, (i, nj)));
                        visited.insert((Direction::Left, (i, nj)), nval);
                    }
                }
            ...
            Direction::Left | Direction::Right => {
                ...
                for di in 1..=10 {
                    ...
                    if ni < matrix.len() {
                        pval += matrix[ni][j];
                        if di >= 4 && pval < *visited.get(&(Direction::Down, (ni, j))).unwrap_or(&i32::MAX) {
                            heap.push((Reverse(pval), Direction::Down, (ni, j)));
                            visited.insert((Direction::Down, (ni, j)), pval);
                        }
                    }
                    ...
                    let ni = i - di;
                    nval += matrix[ni][j];
                    if di >= 4 && nval < *visited.get(&(Direction::Up, (ni, j))).unwrap_or(&i32::MAX) {
                        heap.push((Reverse(nval), Direction::Up, (ni, j)));
                        visited.insert((Direction::Up, (ni, j)), nval);
                    }
                }
